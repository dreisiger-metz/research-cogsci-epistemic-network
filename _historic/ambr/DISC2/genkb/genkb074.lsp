...
(with-agent  color-of
  :instance  ((color-of-wtp 0.400)
              (*other* 0.900) )
)

(with-agent  temperature-of
  :instance  ((t-of-gp-w 0.400)
              (htsrc-is-hot 0.600)
              (t-of-bf-f 0.200)
