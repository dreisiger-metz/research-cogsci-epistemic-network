...
(with-agent  tea
  :instance  ((tea-stc 0.600)
              (*other* 0.700) )
)

(with-agent  milk
  :instance  ((milk-mtf 0.900)
              (*other* 0.400) )
)
...
(with-agent  color-of
  :instance  ((color-of-erw-e 0.400)
              (*other* 0.700)
              (tomato-is-red 0.200) )
)

(with-agent  temperature-of
  :instance  ((t-of-wtp-w 0.700)
              (t-of-wtp-p 0.300)
              (t-of-gp-p 0.200)
              (htsrc-is-hot 0.100) )
)
