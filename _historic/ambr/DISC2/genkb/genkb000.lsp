...
(with-agent  white
  :instance  ((*other* 0.800)
              (wwine-is-white 0.500) )
)

(with-agent  low-temp
  :instance  ((low-t-fridge 0.800)
              (low-t-mtf 0.300)
              (low-t-icf 0.200) )
)
...
(with-agent  color-of
  :instance  ((white-wine-color 0.400)
              (*other* 0.600)
...
(with-agent  material-metal
  :instance  ((mmetal-erw 0.400)
              (mmetal-ckves 0.300)
              (*other* 0.600) )
)

(with-agent  made-of
  :instance  ((glass-md-gl 0.400)
              (pot-md-clay 0.300)
              (made-of-gwb-g 0.300)
              (stone-md-stone 0.200)
              (*other* 0.100) )
)
