...
(with-agent  temperature-of
  ...
  :instance  ((t-of-ihc-w 0.400)
              (t-of-bf-f 0.300)
              (t-of-sff-fr 0.300)
              (fridge-is-cold 0.200)
              (t-of-mtf-f 0.100) )
)

(with-agent  is-dissipated
  :instance  ((is-dissip-bf 0.600)
              (*other* 0.700) )
)
...
(with-agent  made-of
  :instance  ((saucer-md-china 0.400)
              (made-of-bpf 0.300)
              (made-of-gp 0.300)
              (cup-md-china 0.300) )
)
