...
(with-agent  material-metal
  :instance  ((mmetal-wtp 0.600)
              (*other* 0.700) )
)

(with-agent  made-of
  :instance  ((bottle-md-gl 0.400)
              (made-of-gwb-b 0.300)
              (made-of-bpf 0.300)
              (made-of-icf 0.200)
              (made-of-bf 0.100) )
