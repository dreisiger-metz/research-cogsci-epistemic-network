...
(with-agent  sugar
  :instance  ((sugar-stc 0.700)
              (*other* 0.600) )
)

(with-agent  salt
  :instance  ((salt-sff 0.800)
              (*other* 0.500) )
)
