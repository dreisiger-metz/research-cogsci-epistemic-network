...
(with-agent  salt-taste
  :instance  ((salty-sff 0.800)
              (*other* 0.500) )
)

(with-agent  sweet-taste
  :instance  ((swt-jc-taste 0.700)
              (sweet-stc 0.500)
              (*other* 0.100) )
)
...
(with-agent  temperature-of
  :instance  ((t-of-mtf-f 0.700)
              (t-of-fdo-o 0.500)
              (fridge-is-cold 0.100) )
)
