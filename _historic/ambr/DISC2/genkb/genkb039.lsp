...
(with-agent  oven
  ...
  :instance  ((oven-fdo 0.500)
              (*other* 0.800) )
)

(with-agent  fridge
  :a-link    (t-of-bpf-f 0.200)
  :instance  (*other* 1.300)
)
...
(with-agent  color-of
  ...
  :instance  ((*other* 0.400)
              (color-of-erw-w 0.600)
              (color-of-erw-e 0.300) )
)

(with-agent  temperature-of
  :instance  ((t-of-mtf-f 0.400)
              (t-of-fdo-f 0.300)
              (t-of-wtp-p 0.300)
              (htsrc-is-hot 0.200)
              (t-of-sff-fr 0.100) )
...
(with-agent  made-of
  :instance  ((ckves-md-metal 0.400)
              (made-of-gwb-g 0.300)
              (stone-md-stone 0.300)
              (made-of-gwb-b 0.200)
              (plate-md-china 0.100) )
)
