...
(with-agent  color-of
  :instance  ((color-of-mtf 0.400)
              (*other* 0.600)
              (snowdrop-is-white 0.200)
              (color-of-erw-e 0.100) )
)

(with-agent  temperature-of
  :instance  ((t-of-bpf-f 0.700)
              (t-of-gp-p 0.300)
              (htsrc-is-hot 0.200)
              (t-of-sff-fr 0.100) )
)
