// ============================================================================
// Filename          : $RCSfile: FeatureVectorTest.hpp,v $
...
// Revision history  : 
// ============================================================================
#ifndef libFGREP__FeatureVectorTest_hpp
#define libFGREP__FeatureVectorTest_hpp
...
namespace ANN {
  ...
  namespace Test {
    ...
    class FeatureVectorTest : public CPPUNIT_NS::TestFixture {
      CPPUNIT_TEST_SUITE(FeatureVectorTest);
