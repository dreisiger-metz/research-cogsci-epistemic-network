...
namespace ANN {
  ...
  public:
    ...
    //  ======================================================================80
    unsigned addSentence(std::string sentence, double weight = 1.0) throw (Exception::UnknownTerm);
    ...
    /// and per-sentence errors squared; it also saves the sentences' pattern
    /// of activation.
    ///
    ...
    /// a map between the string term names and their corresponding 
    /// distributed representation structures
    std::map<std::string, DistributedRepresentationBase*> termRepresentationMap;

    /// a vector of the sentences used to train the network/develop the
    /// distributed representations
    std::vector<DistributedSentenceRepresentation*> sentence;
